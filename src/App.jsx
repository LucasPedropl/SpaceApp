			...
			<AppContainer>
				...
				<MainContainer>
					...
					<ConteudoGaleria>
						...
						<Galeria aoFotoSelecionada={(foto) => setFotoSelecionada(foto)} fotos={fotosDaGaleria} fotosPopulares={fotosPopulares} />
						<Populares />
					</ConteudoGaleria>
				</MainContainer>
			</AppContainer>
			<ModalZoom foto={fotoSelecionada} onClose={fecharModal} />
		</FundoGradiente>
	);
};
